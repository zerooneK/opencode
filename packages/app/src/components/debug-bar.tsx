...
export function DebugBar() {
  ...
  return (
    <aside
      ...
      class="pointer-events-auto fixed top-12 right-3 z-50 w-[308px] max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border border-border-base bg-surface-raised-stronger-non-alpha p-0.5 text-text-strong shadow-[var(--shadow-lg-border-base)] sm:top-12 sm:right-4 sm:w-[324px]"
    >
